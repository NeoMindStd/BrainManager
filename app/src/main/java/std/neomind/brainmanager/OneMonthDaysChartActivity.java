...
public final class OneMonthDaysChartActivity extends AppCompatActivity {

    private LineChart mChart;
    private LineChart mChart2;
    private Spinner goalSpinner;
    private Spinner goalSpinner2;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.content_one_month_days_chart);

        mChart = findViewById(R.id.statistics_lineChart_oneMonthChart1);
        mChart2 = findViewById(R.id.statistics_lineChart_oneMonthChart2);
