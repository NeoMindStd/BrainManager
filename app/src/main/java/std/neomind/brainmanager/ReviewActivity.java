...
//            }
    ...
    private View.OnClickListener onNextClickEvent = new View.OnClickListener() {
        ...
        public void onClick(View v) {
            ...
            if (++mCurrentKeyIndex < mKeywordsSize)
                currentExamType = generate_view(mTargetKeywords.get(mCurrentKeyIndex));
            else {
        ...
        public void onClick(View v) {
            ...
            if (passed) {
                Snackbar.make(v, getString(R.string.ReviewActivity_correct), Snackbar.LENGTH_LONG)
                        .setAction(getString(R.string.Global_OK), view -> {
                        }).show();
            } else {
...
//        Date collectReviewDate;
        ...
        else if (answerTime > 5000 && answerTime < 10000)
            rating = 2;             // 빨리 풀었지만 오답. 너무 빨리풀었는데 오답인경우 그냥 찍은걸로 치부
