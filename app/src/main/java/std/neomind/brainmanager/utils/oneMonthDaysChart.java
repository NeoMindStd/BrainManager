...
public class oneMonthDaysChart extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mChart = (LineChart) findViewById(R.id.oneMonthChart1);
        mChart2 = (LineChart) findViewById(R.id.oneMonthChart2);
